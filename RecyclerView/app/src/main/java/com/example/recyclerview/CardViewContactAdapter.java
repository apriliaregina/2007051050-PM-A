...
private Context context;
        ...
        public void onItemClicked(View view, int position) {
            Toast.makeText(context, "Start Audio Call"+getContactList().get(position).getName(), Toast.LENGTH_SHORT).show();
        }
}));
        ...
        @Override
        public void onItemClicked(View view, int position) {
            Toast.makeText(context, "Start Video Call"+getContactList().get(position).getName(), Toast.LENGTH_SHORT).show();
        }
}));
        }
